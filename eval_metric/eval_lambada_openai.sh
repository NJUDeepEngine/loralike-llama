...
DEVICE="cuda:0"
BATCH_SIZE="auto:4"
OUTPUT_PATH="/data0/butao/cmpLlama/eval_metric/results/lambada_openai"

export PYTHONPATH=/data0/butao/cmpLlama:$PYTHONPATH

python eval_entry.py \
    --model hf \
    --model_args pretrained=$BASELINE_MODEL_NAME,dtype=$DTYPE \
    --tasks $TASKS \
    --device $DEVICE \
    --batch_size $BATCH_SIZE \
    --output_path $OUTPUT_PATH \
    --wandb_args project="amp-llama-test",name="eval-baseline-llama-lambada-openai"